incPsgBtn = document.getElementById('inc-psg-btn');
dcrPsgBtn = document.getElementById('dcr-psg-btn');
psgNumber = document.getElementById('psg-input');

psgNumber.addEventListener("input", function (e) {
    if (e.target.value < 1) {
        psgNumber.value = 1;
    }
})

incPsgBtn.addEventListener("click", function (e) {
    psgNumber.value = parseInt(psgNumber.value) + 1;
    e.preventDefault();
})

dcrPsgBtn.addEventListener("click", function (e) {
    psgNumber.value = parseInt(psgNumber.value) - 1;
    if (psgNumber.value < 1) {
        psgNumber.value = 1;
    }
    e.preventDefault();
})
